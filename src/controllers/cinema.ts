...
export default class CinemaController {
  ...
  static async createCinema(req: Request, res: Response) {
    ...
    // Purchase the first two free consecutive seats in cinema.
    // If there are no two consecutive seats available, return an error, otherwise return the list of seats.
    static async purchaseConsecutiveSeats(req: Request, res: Response) {
      try {
  ...
  static async purchaseSeat(req: Request, res: Response) {
    try {
